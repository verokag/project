...
{
    public class MarcaAcceso
    {
        public ResultadoEntidad SeleccionarMarcas(MarcaEntidad Marca, string CadenaConexion)
        {
            ...
            try
            {
                Comando = new SqlCommand("SeleccionarMarcasProcedimiento", Conexion);
                Comando.CommandType = CommandType.StoredProcedure;

                Parametro = new SqlParameter("MarcaId", SqlDbType.SmallInt);
                Parametro.Value = Marca.MarcaId;
                Comando.Parameters.Add(Parametro);

                Parametro = new SqlParameter("Nombre", SqlDbType.VarChar);
                Parametro.Value = Marca.Nombre;
                Comando.Parameters.Add(Parametro);
